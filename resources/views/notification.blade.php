    ...
    <div class="p-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden border border-gray-200">
            <ul class="divide-y divide-gray-100">
                ...
                <li class="px-6 py-4 hover:bg-gray-50 transition {{ is_null($notification->read_at) ? 'bg-blue-50' : '' }}">
                ...
                <li class="px-6 py-12 text-center">
                    ...
                    <p class="text-gray-400 text-sm mt-1">Notifikasi akan muncul saat ada aktivitas pada karya Anda</p>
                </li>
                @endforelse
            </ul>
        </div>
