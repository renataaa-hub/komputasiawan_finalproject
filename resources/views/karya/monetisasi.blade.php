    ...
    <div class="flex h-screen">
        ...
        <aside class="w-20 bg-white border-r border-gray-200 flex flex-col items-center py-6">
            ...
            <main class="flex-1 p-6">
                ...
                <h1 class="text-2xl font-bold text-gray-800 mb-6">Monetisasi Karya</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow">
                        ...
                        <p class="text-3xl font-bold text-blue-600 mt-2">Rp 1.450.000</p>
                    </div>

                    <div class="bg-white p-6 rounded-xl shadow">
                        <h3 class="text-gray-600">Total Pendapatan</h3>
                        <p class="text-3xl font-bold text-green-600 mt-2">Rp 12.800.000</p>
                    </div>

                    <div class="bg-white p-6 rounded-xl shadow">
                        <h3 class="text-gray-600">Pembaca Premium</h3>
                        <p class="text-3xl font-bold text-purple-600 mt-2">245 Orang</p>
                    </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow mb-8">
                    <h2 class="text-lg font-semibold mb-4 text-gray-700">Grafik Pendapatan</h2>
                    <div class="w-full h-56 bg-gray-200 rounded-lg flex items-center justify-center text-gray-500">
                ...
                <!-- Transaction Table -->
                <div class="bg-white p-6 rounded-xl shadow">
                    <h2 class="text-lg font-semibold mb-4 text-gray-700">Riwayat Transaksi Monetisasi</h2>

                    <table class="w-full text-left">
                        <thead>
                            <tr class="border-b">
                                <th class="py-2">Tanggal</th>
                                <th class="py-2">Karya</th>
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                <td class="py-3">12 Feb 2025</td>
                                <td>Titik Balik Hujan</td>
                                <td class="text-blue-600">Pembelian Bab</td>
                                <td class="font-semibold">Rp 8.000</td>
                            </tr>

                            <tr class="border-b hover:bg-gray-50">
                                <td class="py-3">10 Feb 2025</td>
                                <td>Pena di Atas Awan</td>
                                <td class="text-green-600">Premium Subscribe</td>
                                <td class="font-semibold">Rp 25.000</td>
                            </tr>

                            <tr class="hover:bg-gray-50">
                                <td class="py-3">5 Feb 2025</td>
                                <td>Ruang Tanpa Kata</td>
                                <td class="text-yellow-600">Bonus Creator</td>
                                <td class="font-semibold">Rp 100.000</td>
                            </tr>
