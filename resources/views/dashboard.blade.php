...
<body class="bg-gray-50">
    ...
    <div class="fixed left-0 top-16 h-[calc(100vh-4rem)] w-20 bg-white shadow-lg z-40 hidden md:flex flex-col items-center py-6">
        <nav class="flex-1 flex flex-col gap-4">
            ...
            <a href="{{ route('karya.statistik') }}" class="group relative flex flex-col items-center gap-1 p-3 rounded-xl hover:bg-gray-100 text-gray-600 hover:text-blue-600 transition">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('karya.monetisasi') }}" class="group relative flex flex-col items-center gap-1 p-3 rounded-xl hover:bg-gray-100 text-gray-600 hover:text-blue-600 transition">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
